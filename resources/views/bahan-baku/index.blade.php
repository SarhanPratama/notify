        ...
        <!-- Simple Tables -->
            ...
            <div class="card">
                ...
                <h6 class="font-weight-bold text-light text-sm">{{ $breadcrumbs[count($breadcrumbs) - 1]['label'] }}</h6>
                    ...
                    <button type="button" class="btn btn-outline-light btn-sm btn-lg" data-toggle="modal" data-target="#createModal">
                        Tambah
                    </button>
                </div>
                ...
                <table class="table table-striped text-sm" id="dataTableHover">
                    ...
                    <tbody>
                        ...
                        <tr class="text-start text-nowrap ">
                            ...
                            <td class="align-middle"><span class="badge bg-success">{{ $item->stok }} {{ $item->satuan->nama }}</span></td>
                            <td class="align-middle"><span class="badge bg-success">{{ $item->stok_minimum }} {{ $item->satuan->nama }}</span></td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header bg-warning">
                                        <h5 class="modal-title text-light font-weight-bold" id="editModalLabel">Form Edit</h5>
                                        ...
                                        <div class="modal-body text-sm fw-bold">
                                            ...
                                            <div class="row">
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <input type="number" name="stok" class="form-control form-control-sm" value="{{ $item->stok }}" placeholder="Masukkan stok">
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <label>Stok Minimum <span class="text-danger">*</span></label>
                                                    <input type="number" name="stok_minimum" class="form-control form-control-sm" value="{{ $item->stok_minimum }}" placeholder="Masukkan stok minimum">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between">
                                                    <label for="select2Single" class="form-label fw-bold">Satuan <span
                                                            class="text-danger">*</span></label>
                                                    <a class="text-danger text-decoration-underline" href="javascript:void(0);"
                                                        data-toggle="modal" data-target="#satuanModal">Tambah Satuan</a>
                                                </div>
                        ...
                        <div class="modal fade" id="DestroyModal{{ $item->id }}" tabindex="-1" aria-labelledby="DestroyModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Apakah anda yakin ingin menghapus bahan baku <strong>"{{ $item->nama }}"</strong>?</p>
                                    </div>
        ...
        <form action="{{ route('bahan-baku.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body text-sm fw-bold">
                ...
                <div class="row">
                    <div class="col-6 mb-3">
                        <label>Stok <span class="text-danger">*</span></label>
                        <input type="number" name="stok" class="form-control form-control-sm"  placeholder="Masukkan stok">
                    </div>
                    <div class="col-6 mb-3">
                        <label>Stok Minimum <span class="text-danger">*</span></label>
                        <input type="number" name="stok_minimum" class="form-control form-control-sm"  placeholder="Masukkan stok minimum">
                    </div>
                </div>
                <div class="mb-3">
