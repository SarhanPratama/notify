            ...
            <div class="card">
                <div class="card-header py-3 d-flex align-items-center justify-content-between bg-maron">
                    ...
                    <button type="button" class="btn btn-outline-light btn-sm" data-toggle="modal"
                        data-target="#createKategoriModal">Tambah</button>
                </div>
                    ...
                    <table class="table table-striped text-sm" id="dataTableHover">
                        ...
                        <tbody>
                            @foreach ($kategori as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-outline-warning" data-toggle="modal"
                                            data-target="#editKategoriModal{{ $item->id }}"><i
                                                class="fa fa-pencil"></i></button>
                                        <button class="btn btn-sm btn-outline-danger" data-toggle="modal"
                                            data-target="#deleteKategoriModal{{ $item->id }}"><i
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade" id="deleteKategoriModal{{ $item->id }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
