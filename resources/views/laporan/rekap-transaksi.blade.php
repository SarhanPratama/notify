            ...
            <div class="card border-left-{{ $netProfit >= 0 ? 'success' : 'danger' }} shadow h-100 p-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div
                                class="text-xs font-weight-bold text-{{ $netProfit >= 0 ? 'success' : 'danger' }} text-uppercase mb-1">
                                Net Profit
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                        ...
                        <div class="col-auto">
                            <i
                                class="fas fa-{{ $netProfit >= 0 ? 'chart-line' : 'chart-line-down' }} fa-2x text-{{ $netProfit >= 0 ? 'success' : 'danger' }}"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <small class="text-muted">
                                {{ \Carbon\Carbon::parse($tanggal_awal)->diffInDays(\Carbon\Carbon::parse($tanggal_akhir)) + 1 }}
                                Hari
                            </small>
                        </div>
                        <div class="col-auto">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <strong class="text-danger">Rp
                                            {{ number_format($item['total_pembelian'], 0, ',', '.') }}</strong>
                                    </td>
                                </tr>
                            @empty
                                <tr>
