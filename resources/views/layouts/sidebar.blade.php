<ul class="navbar-nav sidebar sidebar accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseProduk" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed  {{ request()->routeIs('users.index') || request()->routeIs('cabang.index') ? '' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapseUser" aria-expanded="{{ request()->routeIs('users.index') || request()->routeIs('cabang.index') ? 'true' : 'false' }}"
          aria-controls="collapseUser">
          <i class="fa fa-cog" aria-hidden="true"></i>
          <span>Konfigurasi</span>
        </a>
        <div id="collapseUser" class="collapse
        {{ request()->routeIs('users.index') || request()->routeIs('cabang.index') ||
        request()->routeIs('role.index') || request()->routeIs('permission.index') ||
        ...
        " aria-labelledby="headingKaryawan" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            {{-- <h6 class="collapse-header">Forms</h6> --}}
            <a class="collapse-item {{ request()->routeIs('users.index') ? 'active font-weight-bold' : '' }}" href="{{ route('users.index')}}">Karyawan</a>
