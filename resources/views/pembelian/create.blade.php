                    ...
                    <form action="{{ route('pembelian.cart.create.add') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" id="harga_display" class="form-control" min="0" required 
                                    placeholder="0" value="{{ old('harga') ? number_format(old('harga'), 0, ',', '.') : '' }}">
                                ...
                                @forelse ($cartItems as $index => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('pembelian.cart.create.remove', $index) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
