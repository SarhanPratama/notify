    ...
    @if ($pembelianPending->count() > 0)
        <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-warning">
                    <h6 class="font-weight-bold text-white text-sm">Menunggu Persetujuan Pengeluaran</h6>
                </div>
                        ...
                        <tbody>
                            @foreach ($pembelianPending as $item)
                                <tr>
                                    ...
                                    <td class="text-nowrap">{{ $item->created_at->translatedFormat('d M Y') }}</td>
                                    <td class=" text-nowrap font-weight-bold">{{ $item->nobukti }}</td>
                                    <td class="text-nowrap">{{ $item->supplier->nama ?? '-' }}</td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-nowrap text-danger fw-bold">Rp.
                                    ...
                                    <td class="align-middle text-nowrap font-weight-bold">
                                        <div class="badge badge-{{ $item->status == 1 ? 'success' : 'danger' }}">

                                            {{ $item->status == 1 ? 'Success' : 'Rejected' }}</td>
                                        </div>
                                <td class="align-middle text-nowrap">
