                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('penjualan.update', $penjualan->nobukti) }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control" type="date" name="tanggal" value="{{ $penjualan->tanggal }}" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label font-weight-bold">
                                                ...
                                                <div class="card-body text-center">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="metode_pembayaran"
                                                               ...
                                                               {{ $penjualan->metode_pembayaran == 'tunai' ? 'checked' : '' }} required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border-warning h-100">
                                                <div class="card-body text-center">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="metode_pembayaran"
                                                               id="kasbon" value="kasbon"
                                                               {{ $penjualan->metode_pembayaran == 'kasbon' ? 'checked' : '' }}>
                                                ...
                                                @foreach ($penjualan->mutasi as $detail)
                                                    <tr class="detail-item">
                                                        <td class="text-center align-middle">
                                                            <span class="badge badge-primary row-number">{{ $loop->iteration }}</span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="number" class="form-control harga"
                                                                       name="harga[]" min="0" step="0.01" value="{{ $detail->harga }}" required readonly>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="input-group input-group-sm">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <input name="catatan" type="hidden" id="catatan" value="{{ $penjualan->catatan }}">
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let rowCounter = {{ count($penjualan->mutasi) }};
            ...
            // Highlight selected payment method pada load
            document.querySelectorAll('input[name="metode_pembayaran"]:checked').forEach(radio => {
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                ...
                if (!confirm('Yakin ingin mengupdate data penjualan ini?')) {
                    e.preventDefault();
                    return false;
                }
            });
            ...
            document.querySelector('button[type="reset"]').addEventListener('click', function() {
                if (confirm('Yakin ingin mereset semua data?')) {
                    location.reload(); // Reload halaman untuk mengembalikan data asli
                }
            });
