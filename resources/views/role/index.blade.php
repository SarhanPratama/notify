            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="card">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <ul class="dropdown-menu mb-4 px-2 ms-3" style="width: 360px;">
                                <form action="{{ route('role.index') }}" method="get">
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-primary btn-sm" type="submit" id="button-addon2"><i
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm btn-lg" data-bs-toggle="modal"
                        ...
                        <table class="table table-striped text-sm">
                            ...
                            <tbody>
                                @foreach ($role as $item)
                                        ...
                                        <td class="d-flex text-nowrap gap-2">
                                            <div>
                                                <button class="btn btn-sm btn-outline-warning" data-bs-toggle="modal"
                                                    data-bs-target="#roleUpdateModal{{ $item->id }}">
                                            ...
                                            <div>
                                                <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal"
                                                    data-bs-target="#roleDestroyModal{{ $item->id }}">
                                    ...
                                    <div class="modal fade" id="roleUpdateModal{{ $item->id }}" tabindex="-1"
                                        aria-labelledby="roleUpdateModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5 font-weight-bold" id="roleUpdateModalLabel">
                                                        Form Update role</h1>
                                                    ...
                                                    <div class="modal-body text-sm">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name"
                                                                ...
                                                                value="{{ $item->name }}" placeholder="Masukkan nama role"
                                                                required>
                                                            @error('name')
                                    ...
                                    <div class="modal fade" id="roleDestroyModal{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Apakah anda yakin ingin menghapus role <strong> {{ $item->name }}
                                                        </strong>?</p>
                                                </div>
