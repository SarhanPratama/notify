    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5 font-weight-bold" id="roleUpdateModalLabel">Form Update role</h1>
        ...
        <form id="updateForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body text-sm">
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control form-control-sm" id="modal_name"  placeholder="Masukkan nama role" required>
                    @error('name')
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    editButtons.forEach(button => {
        button.addEventListener("click", function () {
            ...
            // Set action form
            form.action = `/admin/role/${this.dataset.id}`;
        });
    });
});
</script>
