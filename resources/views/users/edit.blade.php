        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="card shadow-lg">
                    <div
                        class="card-header py-3 text-white d-flex flex-row align-items-center justify-content-between bg-warning">
                                    ...
                                    <div class="row g-3 fw-bold text-sm">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="nama"
                                                name="name" value="{{ $user->name }}" placeholder="Masukkan nama"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                            ...
                                            <input type="date" class="form-control form-control-sm" id="tanggal_lahir"
                                                name="tgl_lahir" value="{{ $user->tgl_lahir }}" required>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="telepon"
                                                name="telepon" pattern="^\+62\d{8,12}$" value="+62{{ $user->telepon }}"
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <select class="form-select select2-single" id="jabatan" name="id_roles"
                                                ...
                                                @foreach ($roles as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ in_array($name, $userRole->toArray()) ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
